...
# sphinx-quickstart on Tue Jun 13 10:29:29 2017.
#
...
## alabaster theme opitons
html_theme_options = {
    'github_button': True,
    'github_type': 'star&v=2',  ## Use v2 button
    'github_user': 'jianlianggao',
    'github_repo': 'papy',
    'github_banner': True,
}
...
latex_documents = [
    (master_doc, 'papy.tex', u'papy Documentation',
     u'J Gao', 'manual'),
]
...
man_pages = [
    (master_doc, 'papy', u'papy Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'papy', u'papy Documentation',
     author, 'papy', 'One line description of project.',
     'Miscellaneous'),
]
